<template>
    <div class="tw-h-screen tw-font-manrope">
      <div class="tw-flex tw-gap-2 tw-h-[90%] tw-items-center tw-flex-col tw-w-full">
        <q-form
        @submit="onSubmit"
        @reset="onReset"
        class="tw-w-fit tw-mt-10"
      >
        <div class="tw-text-center">
          <h1 class="tw-text-black tw-text-2xl tw-font-bold">Sign up Completed</h1>
