  ...
  <div class="tw-w-full" >
    <q-page>
      <q-tabs
        ...
        align="justify"
      >
        <q-tab class="tw-capitalize tw-text-xl tw-font-bold tw-leading-[27px] tw-text-center tw-py-4" name="assignments" label="Assignment" />
        <q-tab class="tw-capitalize tw-text-xl tw-font-bold tw-leading-[27px] tw-text-center tw-py-4" name="quiz" label="Quiz" />
        <q-tab class="tw-capitalize tw-text-xl tw-font-bold tw-leading-[27px] tw-text-center tw-py-4" name="attendance" label="Attendance" />
      </q-tabs>
                  ...
                  :key="'month'+index"
                    expand-separator :label="month.name" header-class="tw-w-full tw-text-[#FB6765] tw-text-xl tw-font-md hover:tw-bg-none tw-bg-[#F3F5F8] tw-border tw-border-[#00000024]">
                      <q-list class="tw-flex tw-items-center tw-my-3 tw-px-2 tw-max-w-full tw-overflow-auto tw-gap-8">
                        <div class="tw-w-fit lg:tw-w-[65vw] tw-mx-auto tw-my-4">
                            <q-card class="tw-rounded-lg shadow-0 tw-border tw-border-gray-[#D9D9D9]">
                                <q-card-section>
                                  <q-list>
                                    <q-item v-for="score in assignment_scores" :key="score.id" class="q-my-sm">
                                      <q-item-section>
                                        <q-item-label class="tw-text-indigo-900 tw-capitalize tw-text-xl tw-font-bold tw-leading-[27px] tw-text-center">{{ score.name }}</q-item-label>
                                      </q-item-section>
                                      <q-item-section>
                                        <q-item-label class="tw-text-black tw-font-normal tw-text-xl tw-leading-[27px]">Score:{{ score.score }}</q-item-label>
                                      </q-item-section>
                                      <q-item-section>
                                        <q-item-label v-if="score.score < 50">
                                          <span class="tw-bg-[#f5587b] tw-text-white tw-py-[6px] tw-font-normal tw-px-3 tw-rounded-full tw-leading-[27px] tw-text-base">Failed</span>
                                        </q-item-label>
                                        <q-item-label v-else>
                                          <span class="tw-bg-[#22eaaa] tw-text-white tw-py-[6px] tw-font-normal tw-px-3 tw-rounded-full tw-leading-[27px] tw-text-base">Passed</span>
                                        </q-item-label>
                                      </q-item-section>
                                      <!-- <q-item-section side>
