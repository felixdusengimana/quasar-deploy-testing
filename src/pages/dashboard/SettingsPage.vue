<template>
  <SettingsComponent :openModel="openModel" :openChangePasswordModel="openChangePasswordModel"/>
  ...
  <q-dialog v-model="EditProfile" persistent>
   <q-card class="tw-pb-3 tw-w-1/2">
     ...
     <q-card-section>
       ...
       @submit="onSubmit"
       >
       <h1 class="tw-font-bold tw-text-center -tw-mt-6 tw-mb-6 tw-text-xl tw-leading-[27px]">Edit profile</h1>
       <input
       type="text"
       v-model="firstName"
       name="firstName"
 ...
 <q-dialog v-model="ChangePassword" persistent>
   <q-card class="tw-pb-3 tw-w-1/2">
     ...
     <q-card-section>
       ...
       >
       <h1 class="tw-font-bold tw-text-center -tw-mt-6 tw-mb-6 tw-text-xl tw-leading-[27px]">Change password</h1>
       <input
       type="text"
       v-model="oldPassword"
       name="oldPassword"
...
<script>
import SettingsComponent from 'src/components/molecules/SettingsComponent.vue';
export default{
